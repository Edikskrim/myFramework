...
<html lang="en">
<head>
    <title>Dark Error Page Responsive Widget Template| Home :: W3layouts</title>
    <!-- Meta tag Keywords -->
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link href="/errors/web/css/font-awesome.min.css" rel="stylesheet" type="text/css" media="all">
    <!-- online-fonts -->
